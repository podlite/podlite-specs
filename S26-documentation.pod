...
Aliaksandr Zahatski <L<C<zag@cpan.org>|mailto:zag@cpan.org>>
...
=begin table :nested
    ...
    file:atricle.pod6 | head1, head2                all head1 and head2 blocks from atricle.pod6 file
...
I possible to define the formule caption using the C<:caption> attribute.
...
Hence, to read Pod documentation you would type things like:
    ...
    raku --doc  DBI::DBD::Metadata

    raku --doc  ./lib/My/Module.pm
...
specify, for example, the output format desired:
    ...
    raku --doc=HTML perldelta  > perldelta.html
